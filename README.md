...
3. Filter the data by the desired time range.
4. Calculate the mean for the specified column, resampling by month or year.
5. Plot the data using matplotlib with appropriate labels and titles.
